// -----------------------------------------------------------------------
// <copyright file="SpectralCentroid.cs" company="">
...
namespace AcoustID.Chromaprint
{
    ...
    /// TODO: Update summary.
    /// </summary>
    internal class SpectralCentroid : IFFTFrameConsumer
    {
        List<int> m_bands;
        double[] m_features;
        IFeatureVectorConsumer m_consumer;

        public SpectralCentroid(int num_bands, int min_freq, int max_freq, int frame_size, int sample_rate,
            IFeatureVectorConsumer consumer)
        {
